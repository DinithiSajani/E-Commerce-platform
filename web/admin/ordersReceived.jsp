...
<html>
    <head>
        <link rel="stylesheet" href="../css/orderReceived-style.css"><!-- comment -->
        <title>Home</title>
        <style>
            .th-style
            { width: 25%;}
    ...
    <body>
        ...
        <%
            ...
            %>
        <h3 class="alert">Order Cancel Successfully!</h3><!-- comment -->
        <%} %>
        <%
            if("delivered".equals(msg)){
            %>
            <h3 class="alert">Successfully Updated!</h3><!-- comment -->
            <%} %>
            <%
