...
try
{
 ...
 String q3="create table cart(email varchar(100),product_id int,quality int, price int, total int, address varchar(500),city varchar(100),state varchar(100), country varchar(100),mobileNumber bigint,orderDate varchar(100),deliveryDate varchar(100),paymentMethod varchar(100),transactionId varchar(100),status varchar(10)";
 ...
 System.out.printin(q2);
 System.out.printin(q3);
 System.out.printin(q4);
 //st.execute(q1);
 //st.execute(q2);
 //st.execute(q3);
 st.execute(q4);
